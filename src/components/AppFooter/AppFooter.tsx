...
export function AppFooter() {
  return (
    <nav className={"app-footer flex flex-row justify-between items-end"}>
      <ButtonFooter footerBtnTitle="IQ">
        <span>
          <svg
            width="28"
            height="28"
      ...
      <ButtonFooter footerBtnTitle="Offerwall">
        <span>
          <svg
            width="28"
            height="28"
      ...
      <ButtonFooter footerBtnTitle="Home">
        <span
          className={
      ...
      <ButtonFooter footerBtnTitle="Boosters">
        <span>
          <svg
            width="28"
            height="28"
      ...
      <ButtonFooter footerBtnTitle="Friends">
        <span>
          <svg
            width="28"
            height="28"
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <path d="M18.6667 6.99992C18.6667 9.57725 16.5773 11.6666 14 11.6666C11.4227 11.6666 9.33333 9.57725 9.33333 6.99992C9.33333 4.42259 11.4227 2.33325 14 2.33325C16.5773 2.33325 18.6667 4.42259 18.6667 6.99992Z" />
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
